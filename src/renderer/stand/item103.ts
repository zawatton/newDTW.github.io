...
async function item103(this: any) {
        ...
        if (Gvar.var_82[Gvar.var_347][Gvar.var_348] != 0) {
            ...
            if (Gvar.var_83[Gvar.var_2231].Var0 != 50) {
                if (Gvar.var_83[Gvar.var_2231].Var12 == 99) {
                    Gvar.var_83[Gvar.var_2231].Var12 = 0;
                }
                Gvar.var_83[Gvar.var_2231].Var13 = 0;
                if (Gvar.var_83[Gvar.var_2231].Var15 == 0) {
                    Gvar.var_83[Gvar.var_2231].Var14 = 1;
            
                    Adap.DSPLAY(162);
                }
                if (Gvar.var_83[Gvar.var_2231].Var15 != 0) {
                    Gvar.var_83[Gvar.var_2231].Var14 = 0;
                    Gvar.var_83[Gvar.var_2231].Var15 = 0;
                }
                Gvar.var_747 = 1;
            }
        }

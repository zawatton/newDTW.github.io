...
async function func618(this: any) {
        ...
        if (Gvar.var_2882 == 0) {
            await Func.setMessage1("", "全隊戦闘態勢ッ！", 8, false, false, false);
        }
        if (Gvar.var_2882 == 1) {
            await Func.setMessage1("", "狙えェェェェェェェ～～～～～筒！", 8, false, false, false);
        }
        ...
        Adap.DSPLAY(199);
        await Func.setMessage1("形兆はﾊﾞｯﾄﾞｶﾝﾊﾟﾆｰ部隊を呼び出した！", "", 8, false, false, false);

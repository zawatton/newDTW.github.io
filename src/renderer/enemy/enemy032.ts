...
async function enemy032(this: any) {
        ...
        if (Gvar.var_2830 == 0) {
            ...
            if (Gvar.var_474 == 1) {
                ...
                Adap.DSPLAY(181);
                await Func.setMessage1("何かが爆弾にされた！",
                                       "", 8, false, false, false);
        ...
        if (Gvar.var_2830 == 1) {
            await Func.setMessage1("誰にも私を追うことはできない…",
                                   "", 8, false, false, true);
            ...
            Gvar.var_1845 = 0;
            if (Gvar.var_2110 == 0) {
                await Func.setMessage1("君さえ消えていなくなってくれればね…",
                                       "", 8, false, false, true);
                Gvar.var_2197 = 1;
                return;
            }
            ...
            await Func.setMessage1("吉良はｼｱｰﾊｰﾄｱﾀｯｸを繰り出した！",
                                   "", 8, false, false, false);
            Gvar.var_2197 = 1;
        }
        return;

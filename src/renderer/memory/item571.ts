...
async function item571(this: any) {
        ...
        Gvar.var_1252 = 1;
        await Func.setMessage1("あ…新しい予知が…現れた…ぞ…",
                               "", 7, true, false, true);

        Adap.DSPLAY(118);
        await Func.setMessage1("「ﾃﾞｨｱﾎﾞﾛはﾀﾞﾝｼﾞｮﾝを歩いていました。",
        ...
        if (Gvar.var_2202 == 0) {
            Gvar.var_70 = 1;
            await Func.setMessage1("「ﾓﾝｽﾀｰﾊｳｽでﾎﾞｺﾎﾞｺに殴られて",
                                   "リタイアだァーッ！」", 7, false, false, false);
        }
        if (Gvar.var_2202 == 1) {
            Gvar.var_70 = 2;
            await Func.setMessage1("「養分を吸い取られ",
                                  "餓死してリタイアだァーッ！」", 7, false, false, false);
        }
        if (Gvar.var_2202 == 2) {
            Gvar.var_70 = 3;
            await Func.setMessage1("「体中の血を吸われて",
                                   "リタイアだァーッ！」", 7, false, false, false);
        }
        if (Gvar.var_2202 == 3) {
            Gvar.var_70 = 4;
            await Func.setMessage1("「体中を蜂の巣にされて",
                                   "リタイアだァーッ！」", 7, false, false, false);
        }
        if (Gvar.var_2202 == 4) {
            Gvar.var_70 = 5;
            await Func.setMessage1("「泥棒大成功！",
                                   "ﾃﾞｨｱﾎﾞﾛはほんとにラッキー！」", 7, false, false, false);
        }
        if (Gvar.var_2202 == 5) {
            Gvar.var_70 = 6;
            await Func.setMessage1("「トニオさんに殴られて",
                                   "リタイアだァーッ！」", 7, false, false, false);
        }
        if (Gvar.var_2202 == 6) {
            Gvar.var_70 = 7;
            await Func.setMessage1("「大部屋ﾓﾝｽﾀｰﾊｳｽだ！",
                                   "ﾃﾞｨｱﾎﾞﾛは考えるのをやめた。」", 7, false, false, false);
        }
        if (Gvar.var_2202 == 7) {
            Gvar.var_70 = 8;
            await Func.setMessage1("「ｽﾀﾝﾄﾞﾊｳｽで殺されて",
                                   "リタイアだァーッ！」", 7, false, false, false);
        }
        if (Gvar.var_2202 == 8) {
            Gvar.var_70 = 9;
            await Func.setMessage1("「輝く黄金の精神に囲まれて",
                                   "リタイアだァーッ！」", 7, false, false, false);
        }
        if (Gvar.var_2202 == 9) {
            Gvar.var_70 = 10;
            await Func.setMessage1("「囚人の群れに囲まれて",
                                   "リタイアだァーッ！」", 7, false, false, false);
        }
        if (Gvar.var_2202 == 10) {
            Gvar.var_70 = 11;
            await Func.setMessage1("「広大な砂漠で行き倒れて",
                                   "リタイアだァーッ！」", 7, false, false, false);
        }
        if (Gvar.var_2202 == 11) {
            Gvar.var_70 = 12;
            await Func.setMessage1("「どこへ行くのかわからなくて",
                                   "リタイアだァーッ！」", 7, false, false, false);
        }
        if (Gvar.var_2202 == 12) {
            Gvar.var_70 = 13;
            await Func.setMessage1("「俺が最強だぁああああ―――ッ！」",
                                   "", 7, false, false, false);
        }
        // No = 1 なので、ホテルの外
        if (Gvar.dungeon_number == 1 && Gvar.current_floor == 11) {
            await Func.setMessage1("「ベンキを舐めさせられて",
                                   "リタイアだァーッ！」", 7, false, false, false);
            Gvar.var_70 = 0;
        }
        // No = 2 なので、レクイエムの大迷宮
        if (Gvar.dungeon_number == 2 && Gvar.current_floor == 29) {
            await Func.setMessage1("「わけもわからず殺されて",
                                   "リタイアだァーッ！」", 7, false, false, false);
            Gvar.var_70 = 0;
        }
        // No = 3 なので、ディアボロの試練

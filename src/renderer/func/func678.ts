...
async function func678(this: any) {
        Adap.dbgprt(678);
        if (Gvar.var_336 >= 200) {
            return;
        }
        ...
        if (Gvar.var_83[Gvar.var_314].Var0 == 144) {
            Gvar.var_78[Gvar.var_866].Var0 = 730;
        }
        if (Gvar.var_83[Gvar.var_314].Var0 == 116) {
            Gvar.var_78[Gvar.var_866].Var0 = 731;
        }
        ...
        if (Gvar.var_78[Gvar.var_866].Var13 < 0) {
            Gvar.var_78[Gvar.var_866].Var13 = 1;
        }

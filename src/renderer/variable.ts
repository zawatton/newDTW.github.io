...
export interface GlobalVars {
    ...
    var_701 :any,
    var_702 :any,
    var_703 :any, // ボス日記1 存在フラグ (0 = 未作成、!= 0 = 作成済)
    var_704 :any, // 300要素の動的確保配列 (Adap.dim(300)で初期化、用途は呼び出し箇所により異なる)
    var_705 :any, // ボス日記1 プレイヤー名
    var_706 :any, // ボス日記1 最深階
    var_707 :any, // ボス日記1 死亡回数
    var_708 :number, // ボス日記1 エンブレム(ダンジョン(ホテルの外？)クリア時)解放フラグ
    var_709 :number, // ボス日記1 エンブレム(ダンジョン(レクイエムの大迷宮？)クリア時)解放フラグ
    var_710 :any, // ボス日記1 エンブレム(ダンジョン(ディアボロの試練？)クリア時)解放フラグ
    var_711 :any, // ボス日記2 存在フラグ (0 = 未作成、!= 0 = 作成済)
    var_712 :any, // ボス日記2 プレイヤー名
    var_713 :any, // ボス日記2 最深階
    var_714 :any, // ボス日記2 死亡回数
    var_715 :number, // ボス日記2 エンブレム(ダンジョン(ホテルの外？)クリア時)解放フラグ
    var_716 :number, // ボス日記2 エンブレム(ダンジョン(レクイエムの大迷宮？)クリア時)解放フラグ
    var_717 :any, // ボス日記2 エンブレム(ダンジョン(ディアボロの試練？)クリア時)解放フラグ
    var_718 :any, // ボス日記3 存在フラグ (0 = 未作成、!= 0 = 作成済)
    var_719 :any, // ボス日記3 プレイヤー名
    var_720 :any, // ボス日記3 最深階
    var_721 :any, // ボス日記3 死亡回数
    var_722 :number, // ボス日記3 エンブレム(ダンジョン(ホテルの外？)クリア時)解放フラグ
    var_723 :number, // ボス日記3 エンブレム(ダンジョン(レクイエムの大迷宮？)クリア時)解放フラグ
    var_724 :any, // ボス日記3 エンブレム(ダンジョン(ディアボロの試練？)クリア時)解放フラグ
    var_725 :any, // ログイン画面表示モードフラグ (0=タイトル画面、1=ログイン画面)。func146で矢尻カーソル描画条件に使用
    var_726 :any, // ボス日記選択カーソル位置 (1=日記1, 2=日記2, 3=日記3)。func144/func148で使用
    var_727 :any,
    var_728 :any,
    var_729 :any,
    var_730 :any,
    ...
    var_732 :any,
    var_733 :any,
    var_734 :any, // ボス日記モードフラグ (0=冒険プレイモード、1=削除モード)。func144/func147で使用
    var_735 :any, // セーブデータファイル名 ("01.dat"/"02.dat"/"03.dat")。var_726の値に対応
    var_736 :any, // ボス日記削除処理中の一時フラグ (func145のY確認キー処理で使用)
    var_737 :any, // ボス日記削除画面の状態フラグ (func145で使用、処理完了時に0にリセット)
    var_738 :any, // ログイン画面メニュー枠の高さ調整オフセット値 (func146)
    var_739 :any, // ボス日記選択画面の描画X座標 (func148/func149)
    var_740 :any, // ボス日記選択画面の描画Y座標 (走査用、func148/func149)
    var_741 :any, // ボス日記選択画面の描画Y座標基準値 (var_740の初期値を保持)
    var_742 :any,
...
export let Gvar: GlobalVars = {
    ...
    var_904: 0,
    var_905: 0,
    var_906: 1, // カーソル位置 (ゲームスピード, 0: 超速, 1: 速い, 2: 普通, 3: 遅い, 4: 超遅)
    var_907: 0,
    var_908: 0,
    var_909: 0,
    var_910: 0,
